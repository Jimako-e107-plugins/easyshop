...
SC_BEGIN EASYSHOP_STORE_HEADER
	$item = e107::getRegistry('easyshop_store_header');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_MCAT_LINK
	$in_array = e107::getRegistry('easyshop_mcat_link');
...
SC_BEGIN EASYSHOP_MCAT_NOTFOUND
	$item = e107::getRegistry('easyshop_mcat_notfound');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_MCAT_CAT_IMAGE
	$in_array = e107::getRegistry('easyshop_cat_image');
	if ($in_array == '&nbsp;')
	{
		$item = $in_array;
	}
...
SC_BEGIN EASYSHOP_MCAT_CAT_NAME_LINK
	$in_array = e107::getRegistry('easyshop_cat_name');
...
SC_BEGIN EASYSHOP_CAT_DESCR
	$item = e107::getRegistry('easyshop_cat_descr');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_TOTAL_PRODS_IN_CAT
	$item = e107::getRegistry('easyshop_total_prods_in_cat');
...
SC_BEGIN EASYSHOP_ZERO_CAT
	$item = e107::getRegistry('easyshop_zero_cat');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_PAGING
	$item = e107::getRegistry('easyshop_paging');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_FOOTER
	$item = e107::getRegistry('easyshop_store_footer');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_ROW_BREAK
	$item = e107::getRegistry('easyshop_row_break');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_MCAT_CONTAINER
	$item = e107::getRegistry('easyshop_mcat_container');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_SHOW_CHECKOUT
	$item = e107::getRegistry('easyshop_show_checkout');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_NAME
	$item = e107::getRegistry('easyshop_store_name');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_ADDRESS1
	$item = e107::getRegistry('easyshop_store_address1');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_ADDRESS2
	$item = e107::getRegistry('easyshop_store_address2');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_CITY
	$item = e107::getRegistry('easyshop_store_city');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_CONDITIONALBREAK
	$item = e107::getRegistry('easyshop_store_conditionalbreak');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_STATE
	$item = e107::getRegistry('easyshop_store_state');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_ZIP
	$item = e107::getRegistry('easyshop_store_zip');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_CONDITIONALBREAK2
	$item = e107::getRegistry('easyshop_store_conditionalbreak2');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_COUNTRY
	$item = e107::getRegistry('easyshop_store_country');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_STORE_EMAIL
	$in_array = e107::getRegistry('easyshop_store_email');
...
SC_BEGIN EASYSHOP_STORE_WELCOME_MESSAGE
	$item = e107::getRegistry('easyshop_store_welcome_message');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_MCAT_NAME_LINK
	$in_array = e107::getRegistry('easyshop_mcat_name');
...
SC_BEGIN EASYSHOP_ALL_MCAT_CONTAINER
	$item = e107::getRegistry('easyshop_all_mcat_container');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_MCAT_IMAGE
	$in_array = e107::getRegistry('easyshop_mcat_image');
	if ($in_array == '&nbsp;')
	{
		$item = $in_array;
	}
...
SC_BEGIN EASYSHOP_MCAT_DESCR
	$in_array = e107::getRegistry('easyshop_mcat_descr');
...
SC_BEGIN EASYSHOP_MCAT_CONDITIONALBREAK
	$item = e107::getRegistry('easyshop_mcat_conditionalbreak');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_MCAT_LOOSE_TITLE
	$in = e107::getRegistry('easyshop_mcat_loose_title');
...
SC_BEGIN EASYSHOP_ALL_MCAT_LOOSE_CONTAINER
	$item = e107::getRegistry('easyshop_all_mcat_loose_container');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_ALLCAT_TITLE
	$in = e107::getRegistry('easyshop_allcat_action');
	if ($in == "blanks") {
...
SC_BEGIN EASYSHOP_ALLCAT_NO_CATEGORIES
	$item = e107::getRegistry('easyshop_allcat_no_categories');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_ALLCAT_CONTAINER
	$item = e107::getRegistry('easyshop_allcat_container');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_ALLCAT_CAT_NAME_LINK
	$in_array = e107::getRegistry('easyshop_allcat_cat_name_link');
...
SC_BEGIN EASYSHOP_ALLCAT_CONDITIONALBREAK
	$item = e107::getRegistry('easyshop_allcat_conditionalbreak');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_ALLCAT_CAT_IMAGE
	$in_array = e107::getRegistry('easyshop_allcat_cat_image');
	if ($in_array[2] == '') {
		$item .= "&nbsp;";
	} else {
...
SC_BEGIN EASYSHOP_ALLCAT_CAT_DESCRIPTION
	$item = e107::getRegistry('easyshop_allcat_cat_description');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_ALLCAT_TOTAL_PROD_PER_CAT
	$in = e107::getRegistry('easyshop_allcat_total_prod_per_cat');
...
SC_BEGIN EASYSHOP_ALLCAT_CLASS_SPECIFIC
	$item = e107::getRegistry('easyshop_allcat_class_specific');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_ALLCAT_TABLE_TD_END
	$item = e107::getRegistry('easyshop_allcat_table_td_end');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_ALLCAT_SHOW_CHECKOUT
	$item = e107::getRegistry('easyshop_allcat_show_checkout');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_ALLCAT_PAGING
	$item = e107::getRegistry('easyshop_allcat_paging');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_CAT_MCAT_LINK
	$in_array = e107::getRegistry('easyshop_cat_mcat_link');
	$item = '';
	if ($in_array[0] > 0 )
	{
...
SC_BEGIN EASYSHOP_CAT_CATNAME
	$item = e107::getRegistry('easyshop_cat_catname');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_CAT_NO_PRODUCTS
	$item = e107::getRegistry('easyshop_cat_no_products');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_CAT_PROD_IMAGE
	$in_array = e107::getRegistry('easyshop_cat_prod_image');
	if ($in_array[0] == '') {
		$item .= "&nbsp;";
	} else {
...
SC_BEGIN EASYSHOP_CAT_CONTAINER
	$item = e107::getRegistry('easyshop_cat_container');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_CAT_PROD_IMAGE_MORE
	$in_array = e107::getRegistry('easyshop_cat_prod_image_more');
	if ($in_array[0] > 1) {
...
SC_BEGIN EASYSHOP_CAT_PROD_LINK
	$in_array = e107::getRegistry('easyshop_cat_prod_link');
...
SC_BEGIN EASYSHOP_CAT_SHOW_CHECKOUT
	$item = e107::getRegistry('easyshop_cat_show_checkout');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_CAT_OUT_OF_STOCK
	$in_array = e107::getRegistry('easyshop_cat_out_of_stock');
	$item = "";
	if ($in_array[0] == 2) {
...
SC_BEGIN EASYSHOP_CAT_PROD_PRICE
	$in_array = e107::getRegistry('easyshop_cat_prod_price');
	if ($in_array[3] <> '2')
...
SC_BEGIN EASYSHOP_CAT_PROD_DETAILS_LINK
	$in_array = e107::getRegistry('easyshop_cat_prod_details_link');
	$item = "<a href='".e_SELF."?prod.".$in_array[0]."'>".$in_array[1]."</a>";
	return $item;
SC_END
...
SC_BEGIN EASYSHOP_CAT_ADD_TO_CART
	$item = e107::getRegistry('easyshop_cat_add_to_cart');
	return $item;
SC_END
...
SC_BEGIN EASYSHOP_ADMIN_ICON
	if (ADMIN && getperms("P")) 
	{
		$in_array = e107::getRegistry('easyshop_admin_icon');
...
SC_BEGIN EASYSHOP_CAT_TABLE_TD_END
	$item = e107::getRegistry('easyshop_cat_table_td_end');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_CAT_CONDITIONALBREAK
	$item = e107::getRegistry('easyshop_cat_conditionalbreak');
	return $item;
SC_END
...
SC_BEGIN EASYSHOP_PROD_MCAT_LINK
	$in_array = e107::getRegistry('easyshop_prod_mcat_link');
	$item = '';
	if ($in_array[0] > 0)
	{
		$item = "<a href='".e_SELF."?mcat.".$in_array[0]."'><b>".$in_array[1]."</b></a>";
...
SC_BEGIN EASYSHOP_PROD_CAT_LINK
	$in_array = e107::getRegistry('easyshop_prod_cat_link');
...
SC_BEGIN EASYSHOP_PROD_BREADCRUM
	$item = e107::getRegistry('easyshop_prod_breadcrum');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_PROD_IMAGE
	$in_array = e107::getRegistry('easyshop_prod_image');
...
SC_BEGIN EASYSHOP_PROD_NAME
	$item = e107::getRegistry('easyshop_prod_name');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_PROD_SKU_NUMBER
	$in = e107::getRegistry('easyshop_prod_sku_number');
	$item = '';
	if ($in <> "")
	{
...
SC_BEGIN EASYSHOP_PROD_DESCRIPTION
	$item = e107::getRegistry('easyshop_prod_description');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_PROD_PRICE
	$in_array = e107::getRegistry('easyshop_prod_price');
	if ($in_array[3] <> '2')
	{	// Don't display the price for a quotation product // v1.6m
...
SC_BEGIN EASYSHOP_PROD_COSTS_SHIPPING_FIRST_ITEM
	$in_array = e107::getRegistry('easyshop_prod_costs_shipping_first_item');
	$item = '';
	if ($in_array[1] > 0)
	{
...
SC_BEGIN EASYSHOP_PROD_COSTS_ADDITIONAL_ITEM
	$in_array = e107::getRegistry('easyshop_prod_costs_additional_item');
	$item = '';
	if ($in_array[1] > 0)
	{
...
SC_BEGIN EASYSHOP_PROD_COSTS_HANDLING
	$in_array = e107::getRegistry('easyshop_prod_costs_handling');
	$item = '';
	if ($in_array[1] > 0)
	{
...
SC_BEGIN EASYSHOP_PROD_OUT_OF_STOCK
	$in_array = e107::getRegistry('easyshop_prod_out_of_stock');
	$item = '';
	if ($in_array[0] == 2)
	{
...
SC_BEGIN EASYSHOP_PROD_NON_EXTISTANT
	$in = e107::getRegistry('easyshop_prod_non_extistant');
	$item = '';
	if ($in = 0)
	{
...
SC_BEGIN EASYSHOP_ADD_TO_CART
	$item = e107::getRegistry('easyshop_add_to_cart');
	return $item;
SC_END

// ------------------------------------------------
SC_BEGIN EASYSHOP_PROD_SHOW_CHECKOUT
	$item = e107::getRegistry('easyshop_prod_show_checkout');
	return $item;
SC_END
...
SC_BEGIN EASYSHOP_DOWNLOAD_DATASHEET_LINK
	$in = e107::getRegistry('easyshop_download_datasheet_filename');
	if(isset($in) && $in > 0)
	{
...
SC_BEGIN EASYSHOP_PROD_QUOTATION
	$in_array = e107::getRegistry('easyshop_item_quotation');
...
SC_BEGIN EASYSHOP_CAT_PROD_QUOTATION
	$in_array = e107::getRegistry('easyshop_cat_prod_quotation');
	if(isset($in_array[0]) && $in_array[0] == 2)
	{
		$item = "
		<form method='post' action='".e_SELF."?quotation'>
